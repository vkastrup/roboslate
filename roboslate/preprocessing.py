...
def _require_pillow():
    if Image is None:
        raise ImportError(
            "Pillow is not installed. Run ./install.sh to set up the virtual environment."
        )
...
def normalize_brightness(img):
    ...
    """
    # Use ImageOps.autocontrast — clips top/bottom 2% of pixels to handle blown highlights
